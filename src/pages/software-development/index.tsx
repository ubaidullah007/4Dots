...
const index = () => {
  return (
    <>
      <Head>
        <title>Software Development | 4Dots Solutions LLC - Web & Mobile APP | Artificial Intelligence and Blockchain Development Services</title>
 
        <meta
          name="description"
          content=" 4Dots Solutions LLC - Web & Mobile APP | Artificial Intelligence and Blockchain Development Services - Experience seamless IT operations with 4Dots Solutions's DevOps services. Our strategies optimize your development, deployment, and delivery processes."
          key="desc"
        />
      </Head>
